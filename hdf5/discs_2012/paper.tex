...
\author{
    \IEEEauthorblockN{Kshitij Mehta\IEEEauthorrefmark{1}, John Bent\IEEEauthorrefmark{2}, Aaron Torres\IEEEauthorrefmark{3},
    Gary Grider\IEEEauthorrefmark{3}, Edgar Gabriel\IEEEauthorrefmark{1}}
    \\
...
%\author{Kshitij Mehta, %~\IEEEmembership{Member,~IEEE,}
 %       John Bent, Aaron Torres, Gary Grider %~\IEEEmembership{Fellow,~OSA,}
