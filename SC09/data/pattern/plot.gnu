...
set pointsize 1
set xrange [0:8]
plot 'data.txt' using ($2/1048576):($4*1024) index 0 pt 1 ps 2 t "With PLFS", '' using ($2/1048576):($4*1024) index 1 pt 7 t "PanFS"

set xrange [0:5]
set terminal png giant
set output "pattern.png"
plot 'data.txt' using ($2/1048576):($4*1024) index 0 lt 1 pt 1 ps 2 t "With PLFS", '' using ($2/1048576):($4*1024) index 1 lt 2 pt 7 t "PanFS"
set output "pattern_panfs_only.png"
plot 'data.txt' using ($2/1048576):($4*1024) index 1 lt 2 pt 7 t "PanFS"
